...
//  verifyOtp,
//  sendCsvToTelegram,
//  sendChartToTelegram, // This function will be modified to accept filtered categories
//  deleteInvoice,
//} from "./api";
//import TaskPoller from "./components/TaskPoller";
//import axios from "axios";
...
//ChartJS.register(ArcElement, Tooltip, Legend);
//
//// This function is now memoized inside App component
...
//
//  const [selectedRowId, setSelectedRowId] = useState(null);
//  // New state to manage filtered categories for the chart
//  const [excludedCategories, setExcludedCategories] = useState([]);
//
//
//  const fileInputRef = useRef(null);
...
//        await deleteInvoice(invoiceToDelete, token);
//        setMessage("Invoice deleted successfully!");
//        // Re-fetch invoices after deletion to update the table and chart
...
//
//          {message && (
//            <div className={`p-3 rounded-md mb-4 text-center ${message.includes('failed') || message.includes('Error') || message.includes('expired') || message.includes('unauthorized') ? 'bg-red-100 text-red-700' : 'bg-blue-100 text-blue-700'}`}>
//              {message}
//            </div>
//          )}
//
...
//                </div>
//              ) : (
//                <p className="text-center text-gray-600">No category data available or all categories are excluded.</p>
//              )}
//            </div>
//          </div>
//
